...
<div class="topnav">
    ...
    <button class="dropbtn">Land management 
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="#" id="findplotbyid">Find Plot By Id</a>
<!-- The Modal -->
<div id="findplotbyidModal" class="modal">
  <!-- Modal content -->
<div class="modal-content">
<span class="close">&times;</span>
<center>
 <form>
Find plot by id: <input type="text" name="selectplotid" id="selectplotid">
<input type="button" value ="find" onclick="selectplotbyid(selectplotid.value);">
</form> 
</center>
</div>
</div>
...
<input type="button" value ="Find" onclick="getplotvalue(3,plotvaluemin.value,plotvaluemax.value);">
  ...
  <a href="taxmanagement.php">Tax Management</a>
